...
| Behavior is regression-tested | 309 unittest cases |
...
- High-confidence deadline and amount extraction now covers all retained synthetic facts after false-positive filters run; action confidence remains flat until ranking needs action-specific tiers.
