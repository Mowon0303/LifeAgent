...
- Added a reproducible evaluation and CI package: 264 unit tests, a 142-case golden email extraction eval with current raw deadline/amount/action P=1.000 and R=1.000, demo dry-run generation, redacted-output privacy audit, and source-release audit in GitHub Actions.
...
| Claim | Evidence |
| --- | --- |
| Extraction is evaluated | 142-case golden email extraction set |
| Current raw extraction is clean on synthetic eval | deadline, amount, and action P=1.000 / R=1.000 / F1=1.000 |
| Behavior is regression-tested | 264 unittest cases |
