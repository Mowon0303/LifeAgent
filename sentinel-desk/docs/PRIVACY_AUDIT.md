...
The current implementation was verified by packaging the local tree to `/tmp/sentineldesk.release.zip`, extracting it, and auditing the extracted tree with 121 scanned files and 0 release-artifact issues. The same package/audit boundary is now part of GitHub Actions CI.
