...
The current implementation was verified by packaging the local tree to `/private/tmp/lifeagent-spelled-amounts-20260611.release.zip`, extracting it, and auditing the extracted tree with 118 scanned files and 0 release-artifact issues.
